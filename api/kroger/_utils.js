...
console.log("Kroger utility module loaded");
...
export async function getKrogerToken() {
  ...
  if (!CLIENT_ID || !CLIENT_SECRET) {
    console.error("Kroger Auth Error: Missing CLIENT_ID_KROGER or CLIENT_SECRET_KROGER", { 
      hasId: !!CLIENT_ID, 
      hasSecret: !!CLIENT_SECRET 
    });
    throw new Error("Kroger credentials missing. Please set CLIENT_ID_KROGER and CLIENT_SECRET_KROGER in environment variables.");
  }
